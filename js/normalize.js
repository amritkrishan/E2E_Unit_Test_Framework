 ...
 */
function normalizePersonalDetails(jsonIn) {
...
function normalizeAddressDetails(jsonIn) {
    data = JSON.parse(jsonIn);
    return {
...
exports.N = {
	normalizePersonalDetails: normalizePersonalDetails,
	normalizeAddressDetails: normalizeAddressDetails
}